...
<input type="text" class="form-control" name="name" required="required" value="<?=$special->special_name;?>">
</div>
 <div class="form-group">
...
<label><input type="radio" name="active" value="0" <?=(!$special->active)?'checked':'';?>> Да</label>
</div>
</div>
<div class="form-group">
