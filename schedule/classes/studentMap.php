...
return false;
    ...
    . " SET num_zach=$student->num_zach WHERE user_id=".$student->user_id) ==
1) {
return true;
}
return false;
...
role.name AS role,student.num_zach FROM user INNER JOIN student ON
...
return $res->fetch(PDO::FETCH_OBJ)->cnt;   
    ...
    public function findProfileById($id=null){
        if ($id) {
$res = $this->db->query("SELECT student.user_id,student.num_zach,
