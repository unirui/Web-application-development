...
special.name AS special_name, otdel.name as otdel_name"
...
if ($id) {
$res = $this->db->query("SELECT special.special_id,
special.name AS special_name, otdel.name as otdel_name,special.active"
. " FROM special INNER JOIN otdel ON
special.otdel_id=otdel.otdel_id WHERE special.special_id =
$id");
