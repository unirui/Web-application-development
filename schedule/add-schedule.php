...
<select class="form-control" name="lesson_plan_id"><?= Helper::printSelectOptions(0, (new LessonPlanMap())->arrPlanByTeacherId($idUser));?>
</select>
</div>
<div class="form-group">
<label>Пара</label>
<select class="form-control" name="lesson_num_id"><?= Helper::printSelectOptions(0,$schedule->arrLessonNums());?>
</select>
</div>
<div class="form-group">
...
<div class="form-group"> <button type="submit" name="saveSchedule" class="btn btn-primary">Сохранить</button>
</div>
</form>
</div>
<?php
